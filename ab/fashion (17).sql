...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 08:39 PM
...
(1, 'Lace', '../fabric/lace.jpeg', 'Delicate and romantic, perfect for bridal and special occasions.', 500.00, 24.00, '2024-09-18 15:24:26', 1, 'Out of Stock'),
...
--
ALTER TABLE `customizations`
  MODIFY `OPTION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `measurements`
  MODIFY `MEASUREMENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
